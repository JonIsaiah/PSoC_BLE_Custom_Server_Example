...
CYBLE_API_RESULT_T CyBle_StoreBondingData(uint8 isForceWrite)
{
    ...
    *                                               returned.
    * 
    *  \param uint8 advertisingIntervalType: Fast or slow advertising interval with timings
...
* 
    ...
    *  \param uint8 dest: 0 - selects advertisement structure, not zero value selects scan 
    *              response structure.
* 
    * \return
    *  None
*  
    ...
    * 
    *   \param uint8 scanningIntervalType:  Fast or slow scanning interval with
    ...
    * 
    *  \param const CYBLE_GAP_BD_ADDR_T address: The device address of the remote device to 
    *                                     connect to. 
    ...
    *******************************************************************************/
    CYBLE_API_RESULT_T CyBle_GapcCancelDeviceConnection(void)
    {
        ...
        * 
        *  \param char8 name: The local device name string to be set in advertisement data 
        *            structure.
        *  \param uint8 dest: 0 - advertisement structure, not zero value selects scan response
        *              structure.
        * 
        * \return
        *  None
    ...
    * 
    *  \param char8 name: The local device name string. The name string to be written as
    ...
    *  GAP Service.
    * 
    * \param char8 name: The local device name string. Used to read the local name to the
...
* 
*  \param uint8 * ptr: Pointer to the LSB of two-bytes data (little endian).
* 
*  \return
...
* 
*  \param uint8 * ptr:   Pointer to the LSB of two-bytes data (little endian).
*  \param uint16 value:  Two-bytes data to be written.
* 
*  \return
*  None
* 
