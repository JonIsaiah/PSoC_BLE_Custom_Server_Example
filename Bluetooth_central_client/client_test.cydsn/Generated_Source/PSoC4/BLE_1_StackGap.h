...
*     
*  \param bdHandle: Peer device for which the Out Of Band signalling (OOB) configuration
*             is to be used.
...
*   CYBLE_ERROR_INVALID_OPERATION        | ADV Event is not closed, BLESS isactive or ADV is not enabled.
* 
******************************************************************************/
