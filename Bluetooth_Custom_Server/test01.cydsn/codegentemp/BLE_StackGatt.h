...
typedef enum
{
	...
	*/
    ...
    /** Unknown command error code used by the Apple Notification Center Server when the Client
       sends unknown command value of the the Apple Notification Center Service Control Point 
       Characteristic. */
    ...
    /** Invalid command error code used by the Apple Notification Center Server when the Client
       sends invalid command value of the the Apple Notification Center Service Control Point 
       Characteristic. */
    ...
    /** Invalid parameter error code used by the Apple Notification Center Server when the Client
       sends invalid parameter value of the the Apple Notification Center Service Control Point 
       Characteristic. */
...
*     
*  \param mtu: buffer where Size of MTU will be stored.
* 
* \return
