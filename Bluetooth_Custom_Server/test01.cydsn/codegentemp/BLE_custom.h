...
#define CYBLE_CUSTOMSERVICE_SERVICE_INDEX   (0x00u) /* Index of CustomService service in the cyBle_customs array */
#define CYBLE_CUSTOMSERVICE_TRANSMITDATA_CHAR_INDEX   (0x00u) /* Index of TransmitData characteristic */
#define CYBLE_CUSTOMSERVICE_TRANSMITDATA_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x00u) /* Index of Characteristic User Description descriptor */
#define CYBLE_CUSTOMSERVICE_TRANSMITDATA_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */
#define CYBLE_CUSTOMSERVICE_TRANSMITDATA_SERVER_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x02u) /* Index of Server Characteristic Configuration descriptor */


#define CYBLE_CUSTOMSERVICE_SERVICE_HANDLE   (0x000Cu) /* Handle of CustomService service */
#define CYBLE_CUSTOMSERVICE_TRANSMITDATA_CHAR_HANDLE   (0x000Eu) /* Handle of TransmitData characteristic */
#define CYBLE_CUSTOMSERVICE_TRANSMITDATA_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x000Fu) /* Handle of Characteristic User Description descriptor */
#define CYBLE_CUSTOMSERVICE_TRANSMITDATA_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0010u) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_CUSTOMSERVICE_TRANSMITDATA_SERVER_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0011u) /* Handle of Server Characteristic Configuration descriptor */
