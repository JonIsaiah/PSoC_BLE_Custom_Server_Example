...
*  process.
* 
*  \param CYBLE_GATT_READ_BY_GRP_RSP_PARAM_T *eventParam:  the event parameters for a 
...
*  process.
* 
*  \param CYBLE_GATT_READ_BY_TYPE_RSP_PARAM_T *eventParam: The event parameters for a
...
*  process.
* 
*  \param CYBLE_GATT_FIND_INFO_RSP_PARAM_T *eventParam:  the event parameters for a Find Info Response
* 
* \return
*  None.
* 
