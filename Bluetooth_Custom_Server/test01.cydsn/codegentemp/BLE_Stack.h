...
*              ((CYBLE_ALIGN_TO_4(Size of MTU) + CYBLE_MEM_EXT_SZ + CYBLE_L2CAP_HDR_SZ) * noOfBuffer)
*
...
*  <tr>
*    <td>1</td>
*    <td>Maximum Gatt attribute length</td>
...
* 
*  \param CYBLE_LP_MODE_T pwrMode: The power mode that the component is intended to 
...
*  This is a blocking function. No event is generated on calling this function.
* 
*  \param plainData: Pointer to the data containing plain text (128-bit) that is to be
*              encrypted.
* 
